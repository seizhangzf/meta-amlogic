...
SUMMARY = "Amlogic ISP LENS driver"
LICENSE = "GPLv2"
...
S = "${WORKDIR}/git/linux_54_t7/kernel/subdev/lens/"
...
KERNEL_MODULE_AUTOLOAD += "iv009_isp_lens"
KERNEL_MODULE_PROBECONF += "iv009_isp_lens"
module_conf_iv009_isp_lens = "softdep iv009_isp_lens pre: iv009_isp_iq"
