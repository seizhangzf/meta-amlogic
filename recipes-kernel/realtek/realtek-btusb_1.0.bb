...
do_install() {
    ...
    install -m 0666 ${S}/usb_driver/rtk_btusb.ko ${BT_MODULE_DIR}
...
EXTRA_OEMAKE='-C ${S}/usb_driver M=${S}/usb_driver KERNEL_SRC=${STAGING_KERNEL_DIR} KERNELPATH=${STAGING_KERNEL_DIR} ARCH=${ARCH} CROSS_COMPILE=${CROSS_COMPILE}'
