...
# Wifi FW
SRC_URI += "file://clm_bcm43752a2_pcie_ag.blob"
SRC_URI += "file://fw_bcm43752a2_pcie_ag.bin"
SRC_URI += "file://fw_bcm43752a2_pcie_ag_apsta.bin"
SRC_URI += "file://nvram_ap6275p.txt"
SRC_URI += "file://BCM4362A2.hcd"

# Patch
SRC_URI += "file://0001-Enable-PCIE.patch"

#SRCREV = "e0599cf99ebac232e73d4c76aa7022f0db21921e"

SRCREV ?= "${AUTOREV}"

AP6XXX_KCONFIGS = "KCPPFLAGS='-DCONFIG_BCMDHD_FW_PATH=\"/etc/wifi/bcm/fw_bcmdhd.bin\" -DCONFIG_BCMDHD_NVRAM_PATH=\"/etc/wifi/bcm/nvram_ap6275p.txt\"'"
...
do_install() {
    ...
    mkdir -p ${WIFIDIR}
    install -m 0666 ${S}/bcmdhd.101.10.361.x/dhdpci.ko ${WIFIDIR}
    ...
    install -m 0666 ${WORKDIR}/nvram_ap6275p.txt ${FWDIR}
