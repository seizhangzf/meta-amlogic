...
SRCREV="cfcf122480b2e8154df902df4c1844acf9bfe5fd"
...
do_install () {
    mkdir -p ${D}${datadir}/bootloader/bl31/bin
    cp -rf ${S}/* ${D}${datadir}/bootloader/bl31/bin/
}


FILES_${PN}-dev= "${datadir}/bootloader/bl31/bin/*"
