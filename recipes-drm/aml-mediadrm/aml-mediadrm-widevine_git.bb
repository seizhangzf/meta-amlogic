...
do_install() {
    ...
    install -D -m 0644 ${S}/widevine-bin/${WIDEVINE_VER}/${TA_TARGET}/include/cdm.h ${D}/usr/include
    install -D -m 0644 ${S}/widevine-bin/${WIDEVINE_VER}/${TA_TARGET}/include/OEMCryptoCENC.h ${D}/usr/include
    ...
    install -m 0644 ${S}/widevine-bin/${WIDEVINE_VER}/${ARM_TARGET}/include/cdm/include/*.h ${D}${includedir}/
    install -m 0644 ${S}/widevine-bin/${WIDEVINE_VER}/${ARM_TARGET}/include/core/include/*.h ${D}${includedir}/
